...
const char *ssid_wl           = "xxxxxxxxxxxxxxxxxxxxx";
const char *ssid_ap           = "webrotor";
const char *password          =  "xxxxxxxxxxxxxxxxxxxs";
...
// Look for and handle WebSocket data
  webSocket.loop();
  sent_bearing_ws();
  delay(800);  // experimental value, may be incresed or lowered depending on results of page loading and data changes.
}
